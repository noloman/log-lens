...
@AnalyzeClasses(packages = ["me.manulorenzo.loglens"], importOptions = [ImportOption.DoNotIncludeTests::class])
class ArchitectureTest {
    ...
    val `layered architecture is respected`: ArchRule =
        layeredArchitecture()
            .consideringOnlyDependenciesInAnyPackage("me.manulorenzo.loglens..")
