...
class ArchitectureTest {
    ...
    val `layered architecture is respected`: ArchRule =
        layeredArchitecture()
            ...
            .mayOnlyBeAccessedByLayers("Api", "Service", "Repository", "Config")

    /**
     * Explicit check mentioned in ADR 0001 Compliance section.
     */
    @ArchTest
    val `api should not access repository directly`: ArchRule =
        noClasses()
            .that()
    ...
    @ArchTest
    val `services should be suffixed`: ArchRule =
        classes()
            .that()
    ...
    @ArchTest
    val `repositories should be suffixed`: ArchRule =
        classes()
            .that()
            .resideInAPackage("..repository..")
            .should()
    ...
    @ArchTest
    val `controllers should be suffixed`: ArchRule =
        classes()
            .that()
            .resideInAPackage("..api..")
            .should()
